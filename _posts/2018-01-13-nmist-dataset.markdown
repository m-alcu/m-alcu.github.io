...
[Pytorch example](https://github.com/pytorch/examples/blob/master/mnist/main.py)
[Tensorflow example](https://github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/examples/tutorials/layers/cnn_mnist.py)
